...
{
    public partial class NyTomasosContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Server=.\SQLEXPRESS;Database=NyTomasos;Trusted_Connection=True;");
            }
        }

        public NyTomasosContext(DbContextOptions<NyTomasosContext> options) : base(options)
        {
        }

        public NyTomasosContext()
        {
